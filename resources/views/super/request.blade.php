...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>White Coat Domain - {{auth()->user()->firstname.' ' .auth()->user()->lastname ?? '' }} | Request</title>
        ...
        <link rel="stylesheet" href="{{ asset('css/requestSettings.css') }}">
